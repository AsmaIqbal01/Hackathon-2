        ...
        <section className="popular w-full flex flex-col gap-4">
          <div className="sec grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: 'Nissan GT - R', image: '/car (1).png', desc: 'sport' },
              { title: 'Rolls-Royce', image: '/car (2).png', desc: 'Sport' },
              { title: 'All New Rush', image: '/suv.png', desc: 'Suv' },
              { title: 'CR - V', image: '/suv (4).png', desc: 'Suv' },
              { title: 'ALLNEW TERIOS', image: '/suv (3).png', desc: 'SUV' },
              { title: 'MGZX Exclusive', image: '/suv (2).png', desc: 'Hatchback' },
              { title: 'NEW MGZS', image: '/Suv (1).png', desc: 'SUV' },
              { title: 'MGZX Exclusive', image: '/suv (2).png', desc: 'Hatchback' },
